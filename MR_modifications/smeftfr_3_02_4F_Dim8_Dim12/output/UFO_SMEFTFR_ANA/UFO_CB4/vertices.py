...
V_3 = Vertex(name = 'V_3',
             ...
             couplings = {(0,1):C.GC_60,(0,0):C.GC_59})

V_4 = Vertex(name = 'V_4',
             particles = [ P.A, P.A, P.A, P.Z ],
             color = [ '1' ],
             lorentz = [ L.VVVV10, L.VVVV2 ],
             couplings = {(0,1):C.GC_73,(0,0):C.GC_72})

V_5 = Vertex(name = 'V_5',
             particles = [ P.A, P.A, P.Z, P.Z ],
             color = [ '1' ],
             lorentz = [ L.VVVV10, L.VVVV4 ],
             couplings = {(0,1):C.GC_56,(0,0):C.GC_54})

V_6 = Vertex(name = 'V_6',
             particles = [ P.A, P.Z, P.Z, P.Z ],
             color = [ '1' ],
             lorentz = [ L.VVVV10, L.VVVV5 ],
             couplings = {(0,1):C.GC_80,(0,0):C.GC_79})

V_7 = Vertex(name = 'V_7',
             particles = [ P.Z, P.Z, P.Z, P.Z ],
             color = [ '1' ],
             lorentz = [ L.VVVV10, L.VVVV3 ],
             couplings = {(0,1):C.GC_57,(0,0):C.GC_55})
...
V_9 = Vertex(name = 'V_9',
             ...
             lorentz = [ L.VVVV1, L.VVVV7, L.VVVV8 ],
...
V_101 = Vertex(name = 'V_101',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_69,(0,1):C.GC_71})
...
V_104 = Vertex(name = 'V_104',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_67,(0,1):C.GC_70})
