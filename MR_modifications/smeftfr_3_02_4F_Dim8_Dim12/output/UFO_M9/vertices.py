...
V_3 = Vertex(name = 'V_3',
             ...
             couplings = {(0,0):C.GC_30,(0,1):C.GC_53})
...
V_43 = Vertex(name = 'V_43',
              ...
              color = [ '1' ],
              lorentz = [ L.VVVVS4, L.VVVVS7 ],
              couplings = {(0,0):C.GC_95,(0,1):C.GC_101})

V_44 = Vertex(name = 'V_44',
              particles = [ P.A, P.W__minus__, P.W__plus__, P.Z, P.H, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVVVSS4, L.VVVVSS7 ],
              couplings = {(0,0):C.GC_96,(0,1):C.GC_102})

V_45 = Vertex(name = 'V_45',
              particles = [ P.W__minus__, P.W__minus__, P.W__plus__, P.W__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVVV4, L.VVVV6 ],
...
V_51 = Vertex(name = 'V_51',
              ...
              couplings = {(0,0):C.GC_94,(0,1):C.GC_100})

V_52 = Vertex(name = 'V_52',
              particles = [ P.W__minus__, P.W__plus__, P.Z, P.Z ],
              color = [ '1' ],
              lorentz = [ L.VVVV1, L.VVVV5, L.VVVV6 ],
              couplings = {(0,0):C.GC_82,(0,1):C.GC_55,(0,2):C.GC_61})

V_53 = Vertex(name = 'V_53',
              particles = [ P.W__minus__, P.W__plus__, P.Z, P.Z, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVVVS1, L.VVVVS3, L.VVVVS5 ],
              couplings = {(0,0):C.GC_83,(0,2):C.GC_56,(0,1):C.GC_62})

V_54 = Vertex(name = 'V_54',
              particles = [ P.W__minus__, P.W__plus__, P.Z, P.Z, P.H, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVVVSS1, L.VVVVSS3, L.VVVVSS5 ],
              couplings = {(0,0):C.GC_84,(0,2):C.GC_57,(0,1):C.GC_63})
...
V_58 = Vertex(name = 'V_58',
              ...
              color = [ '1' ],
              lorentz = [ L.VVVVV2, L.VVVVV3 ],
              couplings = {(0,0):C.GC_112,(0,1):C.GC_109})

V_59 = Vertex(name = 'V_59',
              particles = [ P.A, P.W__minus__, P.W__plus__, P.Z, P.Z, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVVVVS2, L.VVVVVS3 ],
              couplings = {(0,0):C.GC_113,(0,1):C.GC_110})

V_60 = Vertex(name = 'V_60',
              particles = [ P.A, P.W__minus__, P.W__plus__, P.Z, P.Z, P.H, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVVVVSS2, L.VVVVVSS3 ],
              couplings = {(0,0):C.GC_114,(0,1):C.GC_111})

V_61 = Vertex(name = 'V_61',
              particles = [ P.W__minus__, P.W__minus__, P.W__plus__, P.W__plus__, P.Z ],
              color = [ '1' ],
              lorentz = [ L.VVVVV5, L.VVVVV7 ],
              couplings = {(0,1):C.GC_68,(0,0):C.GC_75})

V_62 = Vertex(name = 'V_62',
              particles = [ P.W__minus__, P.W__minus__, P.W__plus__, P.W__plus__, P.Z, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVVVVS5, L.VVVVVS7 ],
              couplings = {(0,1):C.GC_70,(0,0):C.GC_77})

V_63 = Vertex(name = 'V_63',
              particles = [ P.W__minus__, P.W__minus__, P.W__plus__, P.W__plus__, P.Z, P.H, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVVVVSS5, L.VVVVVSS7 ],
              couplings = {(0,1):C.GC_72,(0,0):C.GC_79})
...
V_132 = Vertex(name = 'V_132',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_88,(0,1):C.GC_90})
...
V_135 = Vertex(name = 'V_135',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_86,(0,1):C.GC_89})
