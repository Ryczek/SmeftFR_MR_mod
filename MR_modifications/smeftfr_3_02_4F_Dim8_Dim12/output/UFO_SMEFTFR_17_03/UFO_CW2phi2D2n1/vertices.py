...
V_4 = Vertex(name = 'V_4',
             ...
             couplings = {(0,1):C.GC_30,(0,0):C.GC_53})
...
V_6 = Vertex(name = 'V_6',
             ...
             color = [ '1' ],
             lorentz = [ L.VVSS1, L.VVSS2 ],
             couplings = {(0,1):C.GC_75,(0,0):C.GC_93})
...
V_43 = Vertex(name = 'V_43',
              ...
              color = [ '1' ],
              lorentz = [ L.VVVV10, L.VVVV4 ],
              couplings = {(0,0):C.GC_56,(0,1):C.GC_54})
...
V_75 = Vertex(name = 'V_75',
              ...
              color = [ '1' ],
              lorentz = [ L.VVVVVV1, L.VVVVVV4 ],
              couplings = {(0,1):C.GC_80,(0,0):C.GC_97})

V_76 = Vertex(name = 'V_76',
              particles = [ P.W__minus__, P.W__minus__, P.W__plus__, P.W__plus__, P.Z, P.Z, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVVVVVS1, L.VVVVVVS4 ],
              couplings = {(0,1):C.GC_81,(0,0):C.GC_98})

V_77 = Vertex(name = 'V_77',
              particles = [ P.W__minus__, P.W__minus__, P.W__plus__, P.W__plus__, P.Z, P.Z, P.H, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVVVVVSS1, L.VVVVVVSS4 ],
              couplings = {(0,1):C.GC_82,(0,0):C.GC_99})
...
V_153 = Vertex(name = 'V_153',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_101,(0,1):C.GC_104})
