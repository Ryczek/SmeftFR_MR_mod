...
CG2phi2D2n1 = Parameter(name = 'CG2phi2D2n1',
                        nature = 'external',
                        type = 'real',
                        value = 0,
                        texname = 'C^{\\text{G2$\\phi $2D2n1}}',
                        lhablock = 'FRBlock',
                        lhacode = [ 72 ])

CG2phi2D2n2 = Parameter(name = 'CG2phi2D2n2',
                        nature = 'external',
                        type = 'real',
                        value = 0,
                        texname = 'C^{\\text{G2$\\phi $2D2n2}}',
                        lhablock = 'FRBlock',
                        lhacode = [ 73 ])

CG2phi2D2n3 = Parameter(name = 'CG2phi2D2n3',
                        nature = 'external',
                        type = 'real',
                        value = 0,
                        texname = 'C^{\\text{G2$\\phi $2D2n3}}',
                        lhablock = 'FRBlock',
                        lhacode = [ 74 ])

CG2phi4n1 = Parameter(name = 'CG2phi4n1',
                      nature = 'external',
                      type = 'real',
                      value = 0,
                      texname = 'C^{\\text{G2$\\phi $4n1}}',
                      lhablock = 'FRBlock',
                      lhacode = [ 75 ])

CG2phi4n2 = Parameter(name = 'CG2phi4n2',
                      nature = 'external',
                      type = 'real',
                      value = 0,
                      texname = 'C^{\\text{G2$\\phi $4n2}}',
                      lhablock = 'FRBlock',
                      lhacode = [ 76 ])
...
CphiGtilde = Parameter(name = 'CphiGtilde',
                       nature = 'external',
                       type = 'real',
                       value = 0,
                       texname = 'C^{\\text{$\\phi $Gtilde}}',
                       lhablock = 'FRBlock',
                       lhacode = [ 87 ])
