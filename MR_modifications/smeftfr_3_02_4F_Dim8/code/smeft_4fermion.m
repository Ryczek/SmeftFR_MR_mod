...
(* 4-fermion couplings *)
Module[{a, b, c, d, s1, s2, mu$2, mu$1, i, find, fierz, tmp, ia1, ia2, oplist, oplist8, WC, k},

Print[Style["Calculating 4-fermion vertices...",Bold]];

oplist = Intersection[ SMEFT$OperatorList, {"ll","ee","le"}];
oplist8 = Intersection[ SMEFT$OperatorList, {"l3ephiDn3","le3phiDn1","l2e2D2n1","l2e2D2n2","l4D2n1","l4D2n2","e4D2"}];
...
FourLeptonLagrangian = FourLeptonLagrangian /. Lam^k_->If[k>2,0,Lam^k];
FourLeptonLagrangian = FourLeptonLagrangian /. G0->0 /. GP->0 /. GPbar->0;
...
(*
If[ MemberQ[ SMEFT$OperatorList, "l4D2n1" ],

WC = ToExpression[SMEFT$MB <> "l4D2n1"];
...
If[ MemberQ[ SMEFT$OperatorList, "l4D2n2" ],

WC = ToExpression[SMEFT$MB <> "l4D2n2"];
...
(*
If[ MemberQ[ SMEFT$OperatorList, "e4D2" ],
 WC = ToExpression[SMEFT$MB <> "e4D2"];
